...
public final class RootMatchers {
    ...
    public static class MultiRootMatcher extends BaseMatcher<Root> {
        private final Matcher<Root> mWrapped;

        public MultiRootMatcher(Matcher<Root> wrapped) {
            mWrapped = checkNotNull(wrapped);
        }

        @Override
        public boolean matches(Object o) {
            return mWrapped.matches(o);
        }

        @Override
        public void describeTo(Description description) {
            description.appendText("any root matching ");
            mWrapped.describeTo(description);
        }
    }
}
